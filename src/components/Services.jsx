  ...
  return (
    <Section id="how-to-use">
      <div className="container">
        <Heading
          title="Generativer AI made for creators."
          text="YourAI unlocks the potential of AI-powered applications"
        />
        <div className="relative">
          <div
            className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10
           rounded-3xl overflow lg:p-20 xl:h-[46rem]"
          >
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] text-n-3">
                YourAI unlocks the potential of AI-powered application
              </p>
              <ul className="body-2">
